...
export default {
  ...
  methods: {
    setRntenChart() {
      ...
      var myChart = this.$echarts.init(document.getElementById('retention_and_activation'))
      var option = {
        textStyle: {
          color: "#dedede"
        },
        ...
        xAxis: {
          ...
          data: ['02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12', '13', '14', '15', '16']
        },
        yAxis: {
          gridIndex: 0,
          axisLabel: {
        ...
        series: [
          {
            ...
            name: '48小时激活率',
            seriesLayoutBy: 'row',
            data: [0.80, 0.82, 0.83, 0.84, 0.85, 0.86, 0.87, 0.85, 0.84, 0.86, 0.89, 0.90, 0.91, 0.94],
            color: {
              type: 'linear',
              x: 0,
              y: 0,
              ...
              y2: 1,
              colorStops: [{
                offset: 0, color: '#00C779' // 0% 处的颜色
              }, {
                offset: 1, color: '#00D7B7' // 100% 处的颜色
              }],
            }
          },
          {
            ...
            color: {
              ...
              colorStops: [{
                ...
                offset: 1, color: '#00EBFA' // 100% 处的颜色
              }],
            },
            showSymbol: true,
            data: [0.70, 0.72, 0.73, 0.74, 0.75, 0.76, 0.77, 0.65, 0.70, 0.78, 0.79, 0.80, 0.81, 0.84, 0.86],
            label: {
              show: true,
              position: 'bottom',
              color: '#ff4800',
              fontSize: 14,
              formatter: function (params) {  //根据值判断是否显示提示
          ...
          },
          {
            type: 'line',
            name: '七日留存率',
            data: [0.40, 0.42, 0.43, 0.44, 0.45, 0.46, 0.50],
            color: {
              type: 'linear',
              x: 0,
              y: 0,
              ...
              y2: 1,
              colorStops: [{
                offset: 0, color: '#FF4777' // 0% 处的颜色
              }, {
                offset: 1, color: '#FFC3BB' // 100% 处的颜色
              }],
            }
          }
        ]
