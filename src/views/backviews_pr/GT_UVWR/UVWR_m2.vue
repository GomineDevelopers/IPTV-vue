<template>
  <div class="UVWR_m2">
    ...
    <el-row class="chart_body back_white m_marginbottom_pxA">
      ...
      <p class="m_common_content_font">上周移动侧总收视次数1771.6万次，环比下降4.6%；总收视时长1944.5万小时，下降7.0%。</p>
      <!-- <p>各功能均有下跌，点播降幅最大。</p> -->
    ...
    <el-row class="chart_body back_white m_marginbottom_pxA">
      ...
      >去重后移动侧直播用户数32.2万户，环比下降3.9%，一周直播收视次数661.0万次，下降4.3%；直播收视时长502.6万小时，下降4.4%。</p>
    ...
    <el-row class="chart_body back_white m_marginbottom_pxA">
      ...
      <p
        class="m_common_content_font"
      >去重后移动侧一周总点播用户41.2万户，环比下降2.0%。总点播次数1096.7万次，下降4.8%；点播时长1430.1万小时，下降7.9%。</p>
    </el-row>
...
export default {
  ...
  watch: {
    api_data_m2(newValue, oldValue) {
      ...
      vm.GT_UVWR1_L1.data = data10;
      data10B = vm.sortArrZ(data10B, 1);
      vm.GT_UVWR1_L2.data = data10B;
    }
  },
  methods: {
    returnFloat(value) {
