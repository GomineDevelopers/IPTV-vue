          ...
          switch (value.key) {
            case "央视":
              Vue.set(
                ...
                2,
                Number((value.onlive_user_num.value / 10000).toFixed(2))
              );
              Vue.set(
                vm.GT_UVWR1_U2.data[1],
                2,
                Number((value.onlive_freq.value / 10000).toFixed(2))
              );
              Vue.set(
        ...
        demand_user_data.forEach((value, index) => {
          if (index < 10) {
            ...
            Vue.set(
              ...
              1,
              Number((value.demand_user_num.value / 10000).toFixed(2))
            );
            ...
            Vue.set(
              ...
              1,
              Number((value.demand_freq.value / 10000).toFixed(2))
            );
            ...
            Vue.set(
              ...
              1,
              Number((value.demand_dur.value / 10000 / 60).toFixed(2))
            );
          }
        });
      } catch (error) {
        ...
        program_click_data.forEach((value, index) => {
          if (index < 10) {
            ...
            Vue.set(
              ...
              1,
              Number((value.click_user_num.value / 10000).toFixed(2))
            );
            Vue.set(vm.GT_UVWR1_X2.data[10 - index], 0, value.key);
            Vue.set(
              vm.GT_UVWR1_X2.data[10 - index],
              1,
              Number((value.click_freq.value / 10000).toFixed(2))
            );
          }
        });
      } catch (error) {
    ...
    api_data_m3_range(newValue, oldValue) {
      ...
      try {
        ...
        setTimeout(() => {
          ...
          live_temp.forEach((value, index) => {
            if (index > 0) {
              Vue.set(vm.GT_UVWR1_V1.data[index], 2, '');
              ...
              demand_top.forEach((value2, index2) => {
                if (value2.key == value[0]) {
                  ...
                  Vue.set(
                    ...
                    2,
                    (value2.onlive_user_num.value / 10000).toFixed(2)
                  );
                }
              });
            }
      ...
      try {
        ...
        setTimeout(() => {
          ...
          live_temp.forEach((value, index) => {
            if (index > 0) {
              Vue.set(vm.GT_UVWR1_V3.data[index], 1, '');
      ...
      try {
        ...
        setTimeout(() => {
          ...
          live_temp.forEach((value, index) => {
            if (index > 0) {
              Vue.set(vm.GT_UVWR1_W1.data[index], 2, '');
              ...
              demand_user_data.forEach((value2, index2) => {
                if (value2.key == value[0]) {
                  ...
                  Vue.set(
                    ...
                    2,
                    (value2.demand_user_num.value / 10000).toFixed(2)
                  );
                }
              });
            }
        ...
        setTimeout(() => {
          ...
          live_temp.forEach((value, index) => {
            if (index > 0) {
              Vue.set(vm.GT_UVWR1_W2.data[index], 2, '');
              // console.log("页面点击用户数本周", value)
              demand_user_data.forEach((value2, index2) => {
                if (value2.key == value[0]) {
        ...
        setTimeout(() => {
          ...
          live_temp.forEach((value, index) => {
            if (index > 0) {
              Vue.set(vm.GT_UVWR1_W3.data[index], 2, '');
              // console.log("页面点击用户数本周", value)
              demand_user_data.forEach((value2, index2) => {
                if (value2.key == value[0]) {
                  ...
                  Vue.set(
                    ...
                    2,
                    (value2.demand_dur.value / 10000 / 60).toFixed(2)
                  );
                }
              });
            }
      ...
      try {
        ...
        setTimeout(() => {
          ...
          live_temp.forEach((value, index) => {
            if (index > 0) {
              Vue.set(vm.GT_UVWR1_X1.data[index], 2, '');
              // console.log("页面点击用户数本周--", value)
              program_click_data.forEach((value2, index2) => {
                if (value2.key == value[0]) {
                  ...
                  Vue.set(
                    ...
                    2,
                    Number((value2.click_user_num.value / 10000).toFixed(2))
                  );
                }
              });
            }
        ...
        setTimeout(() => {
          ...
          live_temp.forEach((value, index) => {
            if (index > 0) {
              Vue.set(vm.GT_UVWR1_X2.data[index], 2, '');
              ...
              program_click_data.forEach((value2, index2) => {
                if (value2.key == value[0]) {
                  ...
                  Vue.set(
                    ...
                    2,
                    Number((value2.click_freq.value / 10000).toFixed(2))
                  );
                }
              });
            }
      ...
      try {
        ...
        setTimeout(() => {
          ...
          live_temp.forEach((value, index) => {
            if (index > 0) {
              Vue.set(vm.GT_UVWR1_X3.data[index], 2, '');
              ...
              program_play_data.forEach((value2, index2) => {
                if (value2.key == value[0]) {
                  ...
                  Vue.set(
                    ...
                    2,
                    Number((value2.demand_dur.value / 10000 / 60).toFixed(2))
                  );
                }
              });
            }
