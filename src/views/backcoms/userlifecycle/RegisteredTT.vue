...
export default {
  ...
  mounted() {
    ...
    let length = vm.data2_Change.operator.length;
    ...
    for (i = 0; i < length; i++) {
      ...
      series.push(
        ...
        seriesItem(
          vm.data2_Change.region,
          vm.data2_Change.operator[i],
          vm.data2_Change.showData[i],
          vm.data2_Change.color[i],
          barType,
          i
        )
      );
          ...
          label: {
            normal: {
              ...
              formatter: function(params) {
                ...
                for (let z = 0; z < vm.data2_Change.operator.length; z++) {
  ...
  methods: {
    ...
    drawLine2() {
      try {
        ...
        var myChart2 = vm.$echarts.init(
          document.getElementById(vm.data2_Change.id)
        );

        var option2 = vm.option2;
