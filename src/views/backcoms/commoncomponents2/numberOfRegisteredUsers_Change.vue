<template>
  <div class="height_auto">
    ...
    <!-- <el-row style="height:300px;" :id="fillinData_Change.id"></el-row> -->
    <el-row :style="fillinData_Change.height" :id="fillinData_Change.id"></el-row>
  </div>
</template>
<script>
...
export default {
  name: "numberOfRegisteredUsers_Change", //用户注册人数饼图
  props: ["fillinData"],
  data() {
    return {};
  },
        ...
        series: [
          {
            ...
            label: {
              ...
              normal: {
                ...
                formatter: vm.fillinData_Change.label_formatter
              }
            }
          }
        ]
